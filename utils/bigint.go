...
func ConvertIOTXToUniIOTX(iotxRewards, exchangeRatio *big.Int) *big.Int {
	result := big.NewInt(0)
...
func ConvertBigIntToFloat64(number *big.Int, multiplier float64, precision int) float64 {
